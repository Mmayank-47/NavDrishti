...
ssh -o LogLevel=ERROR -o StrictHostKeyChecking=no -i $KEY_PATH "${REMOTE_USER}@${REMOTE_HOST}" "ls -la $REMOTE_DIR/data; du -sh $REMOTE_DIR/data/* 2>/dev/null; df -h /home/zeus"
